...
class ProfileSettingsController: UITableViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func updatePhoto() {
        ...
        if (iApp.sharedInstance.getPhotoUrl().characters.count != 0 && Helper.isInternetAvailable()) {
    ...
    func updateCover() {
        ...
        if (iApp.sharedInstance.getCoverUrl().characters.count != 0 && Helper.isInternetAvailable()) {
